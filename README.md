...
<p align="center">
  <a href="https://hkjang.github.io/Vendra/">🇰🇷 홍보 페이지</a> · <a href="https://hkjang.github.io/Vendra/index_en.html">🇺🇸 English Page</a> · <a href="https://hkjang.github.io/">🌐 전체 서비스</a> · <a href="https://github.com/sponsors/hkjang">💖 Sponsor</a>
</p>
...
docker load < vendra-v0.6.17.tar.gz
docker compose up -d
```
...
```bash
sh scripts/offline-release.sh 0.6.17
docker load < dist/vendra-v0.6.17.tar.gz
```
