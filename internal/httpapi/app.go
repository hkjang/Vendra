...
func (a *App) registerAPI(m routeRegistrar) {
	...
	m.HandleFunc("GET /api/v1/me/sessions", a.listMySessions)
	m.HandleFunc("POST /api/v1/me/sessions/revoke-others", a.revokeMyOtherSessions)
	m.HandleFunc("DELETE /api/v1/me/sessions/{id}", a.revokeMySession)
