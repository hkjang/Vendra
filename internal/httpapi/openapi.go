...
func (a *App) openapi(w http.ResponseWriter, r *http.Request) {
	paths := map[string]any{
		...
		"/api/v1/me/work-inbox":                       map[string]any{"get": operation("Productivity", "권한과 기한을 반영한 통합 업무 인박스")},
		"/api/v1/me/work-items/state":                 map[string]any{"post": operation("Productivity", "업무 완료·보류 상태 일괄 저장")},
		"/api/v1/me/saved-views":                      map[string]any{"get": operation("Productivity", "개인·조직 공유 보기 조회"), "post": operation("Productivity", "필터 보기 저장")},
		"/api/v1/me/saved-views/{id}":                 map[string]any{"parameters": []any{idParameter()}, "patch": operation("Productivity", "저장된 보기 수정"), "delete": operation("Productivity", "저장된 보기 삭제")},
		"/api/v1/me/drafts/{key}":                     map[string]any{"parameters": []any{map[string]any{"name": "key", "in": "path", "required": true, "schema": str("")}}, "get": operation("Productivity", "내 입력 임시저장 조회"), "put": operation("Productivity", "내 입력 자동 저장"), "delete": operation("Productivity", "내 입력 임시저장 삭제")},
		...
		"/api/v1/admin/mail/deliveries":               map[string]any{"get": operation("Administration", "메일 알림 발송 기록 조회")},
		"/api/v1/admin/mail/test":                     map[string]any{"post": operation("Administration", "저장된 SMTP 설정으로 시험 메일 발송")},
